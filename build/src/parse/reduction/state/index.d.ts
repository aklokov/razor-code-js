...
export { rootState, configState, finalState, StateType, implicitExpressionState, explicitExpressionState, injectionState, parenthesisState, squareBracketState, curlyBraceState, angleBracketState, quoteBracketState, apostropheBracketState, subgroupConditionState, braceWaitState, subgroupState, multilineSubgroupState, elseWaitState, commentState, partialState };
